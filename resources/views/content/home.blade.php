...
<style>
    ...
    .instagram-feed-container {
        width: 100%;
        max-width: 1200px;
        /* Batas lebar maksimal biar tidak terlalu melar di monitor gede */
        margin: 0 auto;
        /* Membuat widget otomatis di tengah halaman */
        padding: 15px;
        /* Jarak aman di kanan-kiri layar HP */
        box-sizing: border-box;
    }

    /* Memaksa elemen internal SociableKit agar patuh pada kontainer */
    .sk-instagram-feed {
        width: 100% !important;
...
@section('content')
    ...
    <div class="container float" style="width: 70px; width: absolute;  margin-right: 20px; box-shadow: inset;">
        ...
        <a href="https://api.whatsapp.com/send/?phone=%2B6281329296789&text&app_absent=0" class="text-white hovertext"
            ...
            <img style="width: 60px; margin-top: 0px; margin-bottom: -10px; margin-left:-20%; margin-bottom:55%;"
                src="{{ asset('assets/images/SKY.png') }}" alt="yamaha di solo">
        </a>

        <a href="https://api.whatsapp.com/send/?phone=%2B6281329296789&text&app_absent=0" class="text-white hovertext"
            data-hover="Layanan Booking Service">
            <img style="width: 60px; margin-bottom: 0%; margin-left:-20%;"
                src="{{ asset('assets/images/BOKING SERVICE.png') }}" alt="yamaha di solo">
            </br>
            </br>
        </a>
    ...
    {{-- <div class="container"> --}}
    {{-- <div class="sk-instagram-feed" data-embed-id="25684387"></div><script src="https://widgets.sociablekit.com/instagram-feed/widget.js" defer></script> --}}
    {{-- <iframe src="https://widgets.sociablekit.com/instagram-feed/iframe/25684387" frameborder="0" width="100%" height="800px"></iframe> --}}
    {{-- <div class="row">
        <div class="col-md-12">
    ...
    <div class="instagram-feed-container">
        <!-- Widget asli SociableKit kamu -->
        <div class="sk-instagram-feed" data-embed-id="25684387"></div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="left-content">
                        ...
                        <p>Dealer resmi Yamaha Sumber Baru Rejeki tersebar di 27 cabang area Jawa Tengah, Jawa Timur dan
                            Yogyakarta, Yamaha Sumber Baru Rejeki berkomitmen memberikan pelayanan yang terbaik untuk
                            konsumen. </p>
                ...
                <div class="col-md-6">
                    <div class="right-image">
                        <img style="width: 300px; height:300px;" src="{{ asset('assets/images/tentangkami.jpeg') }}"
                            alt="yamaha di solo">
                    </div>
                </div>
            </div>
    ...
    <div class="services" style="background-image: url({{ asset('assets/images/background.jpeg') }});"
        alr="yamaha di solo">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="container">
                        <div class="row">
                            <iframe class="col-md-6" style="margin-bottom: 10px;" width="560" height="315"
                                src="https://www.youtube.com/embed/4W0etIxet7Q" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                            <iframe class="col-md-6" width="560" height="315"
                                src="https://www.youtube.com/embed/jUaacJIuRTw" title="YouTube video player"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen></iframe>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="owl-clients owl-carousel text-center">
                        <div class="service-item">
                            <div class="">
                                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi1.jpeg') }}"
                                    alt="yamaha di solo">
                                <div> SBR Mantap </div>
                            </div>
                        </div>
                        ...
                        <div class="service-item">
                            <div class="">
                                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi2.jpeg') }}"
                                    alt="yamaha solo">
                        ...
                        <div class="service-item">
                            <div class="">
                                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi3.jpeg') }}"
                                    alt="yamaha di solo">
                        ...
                        <div class="service-item">
                            <div class="">
                                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi4.jpeg') }}"
                                    alt="yamaha di solo">
                        ...
                        <div class="service-item">
                            <div class="">
                                <img style="width: 100%; height:auto;" src="{{ asset('assets/images/testi5.jpeg') }}"
                                    alt="yamaha di solo">
