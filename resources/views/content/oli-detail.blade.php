              ...
              <ul class="list-group list-group-flush">
               <li class="list-group-item">
                    <div class="clearfix">
                         ...
                         <strong class="pull-right">{{ $oli->nama_oli }}</strong>
                    </div>
               </li>
               ...
               <li class="list-group-item">
                    <div class="clearfix">
                         ...
                         <strong class="pull-right">{{ $oli->jenis }}</strong>
                    </div>
               </li>
               <li class="list-group-item">
                    <div class="clearfix">
                         <span class="pull-left">Keterangan</span>

                         <strong class="pull-right">{{ $oli->keterangan }}</strong>
                    </div>
               </li>
               ...
               <li class="list-group-item">
                    <div class="clearfix">
                         ...
                         <strong class="pull-right">{{ $oli->part_code }}</strong>
                    </div>
               </li>
               ...
               <li class="list-group-item">
                    <div class="clearfix">
                         ...
                         <strong class="pull-right">{{ $oli->harga }}</strong>
                    </div>
              </ul>
            </form>
          </div>
